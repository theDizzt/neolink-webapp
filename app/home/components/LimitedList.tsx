  ...
  return (
    <section className="mt-10">
      ...
      <div className="flex items-center justify-between mx-2 mb-4">
        <h3 className="text-[27px] font-normal text-[#E0E3FF] flex items-center">
          <img src="/images/hourglass.png" alt="hourglass" className="mr-2" />
          기간 한정
        </h3>

        {/* 전체 보기 버튼 */}
        <div className="inline-block p-[2px] rounded-full bg-gradient-to-r from-[#504584] to-[#3C184C] shadow-[0_0_8px_2px_rgba(163,139,177,0.5)]">
          <button
            className="w-[104px] h-[37px] rounded-full bg-gradient-to-r from-[#3D366E] to-[#271743] text-[#A38BB1] text-[16px]"
          >
            전체 보기
          </button>
        </div>
